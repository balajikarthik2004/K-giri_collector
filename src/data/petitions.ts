...
export const PETITIONS: Petition[] = [
  ...
  { id: 'US/KRI/40122', subject: bi('Patta still not transferred after the order', 'உத்தரவுக்குப் பின்னும் பட்டா மாற்றம் இல்லை'), petitioner: 'K. Munusamy', mobile: '90xxx 44120', village: bi('Kelamangalam', 'கேளமங்கலம்'), dept: bi('Revenue', 'வருவாய்'), channel: bi('Ungaludan Stalin', 'உங்களுடன் ஸ்டாலின்'), age: 54, officer: 'R. Vinoth', designation: DESIG.tahsildar, phone: '+914347222104' },
  { id: 'PG/KRI/7781', subject: bi('Old age pension not paid for 3 months', '3 மாதமாக முதியோர் ஓய்வூதியம் வரவில்லை'), petitioner: 'A. Lakshmi', mobile: '99xxx 10233', village: bi('Mathur', 'மாத்தூர்'), dept: bi('Social welfare', 'சமூக நலம்'), channel: bi('CPGRAMS', 'மத்திய மனு தளம்'), age: 47, officer: 'D. Priya', designation: DESIG.dswo, phone: '+914343240011' },
